          ...
          <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-3 sm:gap-6">
            ...
            <div className="flex gap-2 sm:gap-3 shrink-0">
              <div className="bg-white/10 backdrop-blur-md rounded-2xl px-3 py-2 sm:p-4 border border-white/15 text-center min-w-[72px] sm:min-w-[90px]">
                <p className="text-lg sm:text-2xl font-black text-amber-300 leading-none">{EXAM_CATALOG.length}</p>
                <p className="text-[10px] font-bold text-slate-200 uppercase tracking-wider mt-1">Exams</p>
              </div>
              <div className="bg-white/10 backdrop-blur-md rounded-2xl px-3 py-2 sm:p-4 border border-white/15 text-center min-w-[72px] sm:min-w-[90px]">
                <p className="text-lg sm:text-2xl font-black text-emerald-300 leading-none">{questions.length}</p>
